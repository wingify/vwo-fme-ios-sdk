...
/**
 * Represents a group of campaigns in Wingify.
 *
 * This class encapsulates information about a group of Wingify campaigns, including its name, associated campaigns, and settings for experiment type, priority, and weight.
 */
