...
/**
 * Represents the context for a Wingify user.
 *
 ...
 * Wingify gateway service.
 */
@objc public class WingifyUserContext:NSObject {
    var id: String?
    ...
    /**
     * Initializes a new instance of WingifyUserContext.
     *
     * - Parameters:
