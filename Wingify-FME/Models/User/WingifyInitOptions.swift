...
/**
 * Represents initialization options for the Wingify SDK.
 *
 * This class provides configuration options for initializing the Wingify SDK, including SDK key, account ID,
 * logging preferences, network client interface, and other settings.
 */
@objc public class WingifyInitOptions: NSObject {
    var sdkKey: String?
    var accountId: Int?
    ...
    var storageConnector: WingifyStorageConnector? = nil
    ...
    /**
     * Initializes a new instance of WingifyInitOptions.
     *
     * - Parameters:
