...
class SetUserAliasAPI {
     ...
     *
     * This method makes an HTTP POST request to the Wingify backend to establish
     ...
     */
    func setUserAlias(tempId: String, userId: String, accountId: Int, sdkKey: String, serviceContainer: ServiceContainer? = nil, loggerService: LoggerService? = nil, completion: @escaping (Result<SetUserAliasResponse, Error>) -> Void) {
        ...
        let requestModel = RequestModel(
            url: UrlService.getBaseUrl(for: .post, serviceContainer: serviceContainer),
