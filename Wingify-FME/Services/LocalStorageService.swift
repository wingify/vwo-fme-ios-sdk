...
class StorageService {
    ...
    private struct Keys {
        static var settings: String { Constants.storageKey("settings") }
        static var version: String { Constants.storageKey("version") }
        static var settingExpiry: String { Constants.storageKey("settingExpiry") }
        static var userDetail: String { Constants.storageKey("userDetail") }
        static var userDetailExpiry: String { Constants.storageKey("userDetailExpiry") }
        static var attributeCheckExpiry: String { Constants.storageKey("attributeCheckExpiry") }
        static var usageStats: String { Constants.storageKey("usageStats") }
        static var aliasID: String { Constants.storageKey("aliasID") }
        static var aliasMappings: String { Constants.storageKey("aliasMappings") }
        static var deviceIdKey: String { Constants.storageKey("deviceIdKey") }
    }
...
     *
     ...
     */
    private func getDataInStorage(featureKey: String?, context: WingifyUserContext) -> [String: Any]? {
     ...
     */
    func updateDataInStorage(featureKey: String, context: WingifyUserContext, data: [String: Any]) -> Bool {
     ...
     * - Returns: A dictionary of stored data if available, otherwise nil.
     */
    func getFeatureFromStorage(featureKey: String, context: WingifyUserContext) -> [String : Any]? {
