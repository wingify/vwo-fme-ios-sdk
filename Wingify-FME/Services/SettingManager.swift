...
class SettingsManager {
    ...
    private static let instanceQueue = DispatchQueue(label: "com.wingify.fme.settingsmanager.instances", attributes: .concurrent)
    ...
    private static let instanceAccessQueue = DispatchQueue(label: "com.wingify.fme.settingsmanager.instance.access")
    ...
    /// between different Wingify accounts.
    ///
    /// - Parameter options: An instance of `WingifyInitOptions` containing initialization parameters like account ID,
    ...
    static func createInstance(options: WingifyInitOptions) -> SettingsManager {
    ...
    ///
    /// - Parameters:
    ///   - options: An instance of `WingifyInitOptions` containing initialization parameters
    ///   - logger: Optional LoggerService instance for instance-specific logging
    /// - Returns: A `SettingsManager` instance specific to the provided account
    static func createInstance(options: WingifyInitOptions, logger: LoggerService?) -> SettingsManager {
    ...
    private func fetchSettings(completion: @escaping (Settings?) -> Void) {
        ...
        let request = RequestModel(url: UrlService.getBaseUrl(for: .get),
