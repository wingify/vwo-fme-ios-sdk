...
class NetworkUtil {
    ...
    private static func generateEventUrl(serviceContainer: ServiceContainer? = nil) -> String {
        ...
        if let container = serviceContainer {
            baseUrl = container.getBaseUrl(for: .post)
        } else {
            // Fallback to static UrlService for backward compatibility
            baseUrl = UrlService.getBaseUrl(for: .post)
        }
    ...
    class func getTrackUserPayloadData(settings: Settings, userId: String?, eventName: String, campaignId: Int, variationId: Int, visitorUserAgent: String?, ipAddress: String?,sessionId: Int64?, context: WingifyUserContext, serviceContainer: ServiceContainer? = nil) -> [String: Any] {
    ...
    static func getTrackGoalPayloadData(settings: Settings, userId: String?, eventName: String, context: WingifyUserContext, eventProperties: [String: Any], serviceContainer: ServiceContainer? = nil) -> [String: Any] {
    ...
    static func sendMessagingEvent(properties: [String: String], payload: [String: Any], serviceContainer: ServiceContainer? = nil) {
        ...
        if let container = serviceContainer {
            baseUrl = UrlService.getBaseUrl(for: .post, serviceContainer: container)
    ...
    static func sendGatewayEvent(queryParams: [String: String], payload: [String: Any], eventName: String, serviceContainer: ServiceContainer? = nil) {
        ...
        let baseUrl = UrlService.getBaseUrl(for: .post, serviceContainer: serviceContainer)
