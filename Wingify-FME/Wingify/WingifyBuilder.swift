...
class WingifyBuilder {
    ...
    private var options: WingifyInitOptions?
    private var settingFileManager: SettingsManager?
    private var originalSettings: Settings? = nil
    // Timer is instance-specific - each wingifyBuilder has its own timer for multi-instance support
    ...
    init(options: WingifyInitOptions?) {
    ...
    // Set WingifyClient instance
    func setWingifyClient(_ wingifyClient: WingifyClient?) {
     ...
     */
    func createServiceContainer(processedSettings: Settings?, options: WingifyInitOptions) -> ServiceContainer {
     ...
     */
    func setStorage() -> WingifyBuilder {
     ...
     * @return The wingifyBuilder instance.
     */
    func setNetworkManager() -> WingifyBuilder {
     ...
     */
    func setSegmentation() -> WingifyBuilder {
     ...
     * @return The instance of this builder.
     */
    func setSettingsManager() -> WingifyBuilder {
        if options == nil {
            return self
        }
     ...
     * @return The instance of this builder.
     */
    func initPolling() -> WingifyBuilder {
     ...
     * Each wingifyBuilder instance maintains its own timer for multi-instance support.
     */
    private func startPolling(interval: Int64) {
        ...
        DispatchQueue.main.async { [weak self] in
            ...
            // The timer will retain self, and self is retained by WingifyClient -> VWOFme
    ...
    /**
     * Stops polling for this specific wingifyBuilder instance.
            ...
            settingMangager.getSettings(forceFetch: true) { settingObj in
                ...
                if let latestSettings = settingObj, let originalSetting = self.originalSettings {
                    ...
                    if isDifferent {
                        ...
                        if let wingifyClient = self.wingifyClient {
                            wingifyClient.updateSettings(newSettings: self.originalSettings)
                        }
    ...
    func setNetworkMonitoring() -> WingifyBuilder {
