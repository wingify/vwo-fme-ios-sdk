...
class SegmentationManager {
     ...
     */
    func setContextualData(settings: Settings, feature: Feature, context: WingifyUserContext, serviceContainer: ServiceContainer) {
        ...
        // and context does not already have Wingify data, fetch from gateway service.
    ...
    // Static method for backward compatibility
    static func setContextualData(settings: Settings, feature: Feature, context: WingifyUserContext) {
