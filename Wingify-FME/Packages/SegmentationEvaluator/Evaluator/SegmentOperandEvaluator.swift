...
class SegmentOperandEvaluator {
    ...
    static func evaluateCustomVariableDSL(_ dslOperandValue: [String: CodableValue], _ properties: [String: Any], _ context: WingifyUserContext?, _ feature: Feature?, serviceContainer: ServiceContainer? = nil) -> Bool {
     ...
     * @return `true` if the operand matches the user properties, `false` otherwise.
     */
    static func evaluateUserDSL(_ dslOperandValue: String, _ properties: [String: Any], _ context: WingifyUserContext?, _ feature: Feature?, serviceContainer: ServiceContainer? = nil) -> Bool {
   ...
   static func evaluateStringOperandDSL(dslOperandValue: String, value: String) -> Bool {
     ...
     */
    static func evaluateUserAgentDSL(_ dslOperandValue: String, _ context: WingifyUserContext?) -> Bool {
