...
class StorageConnectorProvider{
    ...
    private let storageConnector: WingifyStorageConnector?
     ...
     */
    private init(storageConnector: WingifyStorageConnector? = nil){
     ...
     *
     * This method should be called before initializing the Wingify SDK to ensure the custom storage connector
     ...
     * ```
     */
    static func configure(with storageConnector: WingifyStorageConnector?) {
     ...
     * ```
     */
    func getStorageConnector() -> WingifyStorageConnector? {
