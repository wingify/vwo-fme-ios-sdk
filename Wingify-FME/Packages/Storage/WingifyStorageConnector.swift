...
/**
 * A protocol that defines the interface for custom storage connectors in the Wingify FME SDK.
 *
 * This protocol allows developers to implement custom storage solutions for the Wingify SDK,
 * enabling integration with various storage backends such as databases, cloud storage,
 * or custom key-value stores.
 *
 * ## Usage
 * ```swift
 * class MyCustomStorage: WingifyStorageConnector {
 ...
 */
public protocol WingifyStorageConnector {
    func set(_ value: Any?, forKey key: String)
    func get(forKey key: String) -> [String:Any]?
}
