...
internal class LogManager {
    ...
    private var tag = Constants.LOGGER_TAG
    ...
    private let sentMessagesQueue = DispatchQueue(label: "com.wingify.fme.logmanager.sentMessages", attributes: .concurrent)

    
    // Thread-safe singleton implementation
    private static var _instance: LogManager?
    private static let instanceQueue = DispatchQueue(label: "com.wingify.fme.logmanager.instance", attributes: .concurrent)
