...
class CoreDataStack {
    ...
    private let coreDataQueue = DispatchQueue(label: "com.wingify.fme.coredatastack", qos: .userInitiated, attributes: .concurrent)
    ...
    private func setupCoreDataStack() {
        ...
        let storeDir = cachesDir.appendingPathComponent("\(ProductConfig.current.coreDataDirectoryName)/CoreData", isDirectory: true)
        do {
