...
final class TrackEventTests: XCTestCase {
    ...
    override func setUp() {
        super.setUp()
        mockContext = WingifyUserContext(id: "123", customVariables: [:])
    ...
    func testTrackEventSuccess() {
        ...
        let mockOptions: WingifyInitOptions = WingifyInitOptions(sdkKey: "sdk-key", accountId: 123456, integrations: mockCallback)
    ...
    func testTrackEventWithMissingId() {
        ...
        let mockOptions: WingifyInitOptions = WingifyInitOptions(sdkKey: "sdk-key", accountId: 123456, integrations: mockCallback)
        let mockClient = WingifyClient(options: mockOptions, settingObj: mockSettings)
        let contextData = WingifyUserContext(id: "", customVariables: [:])
    ...
    func testTrackEventWithNilId() {
        ...
        let mockOptions: WingifyInitOptions = WingifyInitOptions(sdkKey: "sdk-key", accountId: 123456, integrations: mockCallback)
        let mockClient = WingifyClient(options: mockOptions, settingObj: mockSettings)
        let contextData = WingifyUserContext(id: nil, customVariables: [:])
