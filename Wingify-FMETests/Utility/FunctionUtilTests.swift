...
final class FunctionUtilTests: XCTestCase {
    ...
    override func setUp() {
        ...
        mockOptions = WingifyInitOptions(sdkKey: "sdk-key", accountId: 123456)
        mockClient = WingifyClient(options: mockOptions, settingObj: mockSettings)
